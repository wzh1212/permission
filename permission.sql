...
CREATE TABLE `sys_acl` (
  ...
  `operate_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '最后一次更新时间',
...
-- Records of sys_acl
-- ----------------------------
INSERT INTO `sys_acl` VALUES ('1', '20171015095130_26', '进入产品管理界面', '1', '/sys/product/product.page', '1', '1', '1', '', 'Admin', '2019-03-25 10:04:48', '127.0.0.1');
...
INSERT INTO `sys_acl` VALUES ('11', '20190325104909_69', '产品维护', '1', '/sys/acl/save.json', '1', '1', '5', '', 'Admin', '2019-03-25 10:49:09', '127.0.0.1');
...
INSERT INTO `sys_acl_module` VALUES ('7', '权限管理', '6', '0.6', '1', '1', '', 'Admin', '2019-03-24 17:34:14', '127.0.0.1');
...
INSERT INTO `sys_dept` VALUES ('2', '后端开发', '1', '0.1', '1', '后端', 'Admin', '2019-03-22 21:06:49', '127.0.0.1');
...
INSERT INTO `sys_dept` VALUES ('14', 'Java', '2', '0.1.2', '1', 'Java', 'Admin', '2019-03-22 21:06:37', '127.0.0.1');
INSERT INTO `sys_dept` VALUES ('15', '电话客服', '12', '0.12', '1', '接听电话', 'admin', '2019-03-22 15:52:43', '127.0.0.1');
INSERT INTO `sys_dept` VALUES ('18', 'php', '2', '0.1.2', '2', 'php', 'admin', '2019-03-22 20:19:21', '127.0.0.1');
INSERT INTO `sys_dept` VALUES ('19', 'VR眼镜', '11', '0.11', '1', null, 'Admin', '2019-04-02 10:50:20', '127.0.0.1');
...
CREATE TABLE `sys_log` (
  ...
  `operator` varchar(20) NOT NULL DEFAULT '' COMMENT '操作者',
  `operate_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '最后一次更新的时间',
...
INSERT INTO `sys_log` VALUES ('26', '7', '4', '[1,2,3,9,11,12,13,14,15,16,17,18]', '[1]', 'Admin', '2019-04-01 15:36:50', '127.0.0.1', '0');
INSERT INTO `sys_log` VALUES ('27', '7', '4', '[1]', '[1,6]', 'Admin', '2019-04-01 15:37:16', '127.0.0.1', '0');
INSERT INTO `sys_log` VALUES ('28', '7', '4', '[1,6]', '[1]', 'Admin', '2019-04-01 15:39:52', '127.0.0.1', '0');
INSERT INTO `sys_log` VALUES ('29', '6', '4', '[6,8,9,10]', '[9]', 'Admin', '2019-04-01 15:40:32', '127.0.0.1', '0');
INSERT INTO `sys_log` VALUES ('30', '7', '4', '[1]', '[1,15]', 'Admin', '2019-04-01 15:40:39', '127.0.0.1', '0');
INSERT INTO `sys_log` VALUES ('31', '6', '4', '[9]', '[8,9]', 'Admin', '2019-04-01 15:42:43', '127.0.0.1', '0');
INSERT INTO `sys_log` VALUES ('32', '1', '19', '', '{\"id\":19,\"name\":\"VR眼镜\",\"parentId\":11,\"level\":\"0.11\",\"seq\":1,\"operator\":\"Admin\",\"operateTime\":\"2019-04-02\",\"operateIp\":\"127.0.0.1\"}', 'Admin', '2019-04-02 10:36:00', '127.0.0.1', '0');
INSERT INTO `sys_log` VALUES ('33', '1', '19', '{\"id\":19,\"name\":\"VR眼镜\",\"parentId\":11,\"level\":\"0.11\",\"seq\":1,\"operator\":\"Admin\",\"operateTime\":\"2019-04-02\",\"operateIp\":\"127.0.0.1\"}', '{\"id\":19,\"name\":\"VR眼镜4324\",\"parentId\":11,\"level\":\"0.11\",\"seq\":1,\"operator\":\"Admin\",\"operateTime\":\"2019-04-02\",\"operateIp\":\"127.0.0.1\"}', 'Admin', '2019-04-02 10:36:30', '127.0.0.1', '0');
INSERT INTO `sys_log` VALUES ('34', '1', '19', '{\"id\":19,\"name\":\"VR眼镜4324\",\"parentId\":11,\"level\":\"0.11\",\"seq\":1,\"operator\":\"Admin\",\"operateTime\":\"2019-04-02\",\"operateIp\":\"127.0.0.1\"}', '{\"id\":19,\"name\":\"VR眼镜\",\"parentId\":11,\"level\":\"0.11\",\"seq\":1,\"operator\":\"Admin\",\"operateTime\":\"2019-04-02\",\"operateIp\":\"127.0.0.1\"}', 'Admin', '2019-04-02 10:50:20', '127.0.0.1', '0');
INSERT INTO `sys_log` VALUES ('35', '6', '4', '[8,9]', '[9]', 'Admin', '2019-04-02 10:50:42', '127.0.0.1', '0');
...
INSERT INTO `sys_role` VALUES ('6', '老师管理员', '1', '1', '1132', 'Admin', '2019-03-25 17:20:37', '127.0.0.1');
INSERT INTO `sys_role` VALUES ('7', 'test', '1', '1', 'test参数', 'Admin', '2019-03-25 17:27:07', '127.0.0.1');
...
-- ----------------------------
INSERT INTO `sys_role_acl` VALUES ('18', '1', '6', 'Admin', '2019-03-28 15:06:10', '127.0.0.1');
INSERT INTO `sys_role_acl` VALUES ('19', '6', '9', 'Admin', '2019-03-29 16:50:29', '127.0.0.1');
INSERT INTO `sys_role_acl` VALUES ('23', '4', '9', 'Admin', '2019-04-02 10:50:42', '127.0.0.1');
...
-- ----------------------------
INSERT INTO `sys_role_user` VALUES ('70', '6', '15', 'Admin', '2019-03-29 16:50:39', '127.0.0.1');
INSERT INTO `sys_role_user` VALUES ('87', '4', '1', 'Admin', '2019-04-01 15:40:39', '127.0.0.1');
INSERT INTO `sys_role_user` VALUES ('88', '4', '15', 'Admin', '2019-04-01 15:40:39', '127.0.0.1');
...
INSERT INTO `sys_user` VALUES ('6', 'Kate', '13144445555', 'kate@qq.com', '25D55AD283AA400AF464C76D713C07AD', '1', '1', 'sss', 'Admin', '2017-10-16 23:02:51', '0:0:0:0:0:0:0:1');
INSERT INTO `sys_user` VALUES ('7', 'Kate', '13144445555', 'kate@qq.com', '25D55AD283AA400AF464C76D713C07AD', '1', '1', 'sss', 'Admin', '2017-10-16 23:02:51', '0:0:0:0:0:0:0:1');
INSERT INTO `sys_user` VALUES ('8', 'Kate', '13144445555', 'kate@qq.com', '25D55AD283AA400AF464C76D713C07AD', '1', '1', 'sss', 'Admin', '2017-10-16 23:02:51', '0:0:0:0:0:0:0:1');
INSERT INTO `sys_user` VALUES ('9', 'Kate', '13144445555', 'kate@qq.com', '25D55AD283AA400AF464C76D713C07AD', '1', '1', 'sss', 'Admin', '2017-10-16 23:02:51', '0:0:0:0:0:0:0:1');
INSERT INTO `sys_user` VALUES ('10', 'Kate23', '13144445588', 'kate@qq.com', '25D55AD283AA400AF464C76D713C07AD', '1', '1', 'sss', 'Admin', '2019-03-25 10:03:06', '127.0.0.1');
INSERT INTO `sys_user` VALUES ('11', 'Kate', '13144445555', 'kate@qq.com', '25D55AD283AA400AF464C76D713C07AD', '1', '1', 'sss', 'Admin', '2017-10-16 23:02:51', '0:0:0:0:0:0:0:1');
INSERT INTO `sys_user` VALUES ('12', 'Kate', '13144445555', 'kate@qq.com', '25D55AD283AA400AF464C76D713C07AD', '1', '1', 'sss', 'Admin', '2017-10-16 23:02:51', '0:0:0:0:0:0:0:1');
INSERT INTO `sys_user` VALUES ('13', 'Jimin', '13188889999', 'jimin@qq.com', '25D55AD283AA400AF464C76D713C07AD', '1', '1', 'sss', 'Admin', '2017-10-16 23:02:51', '0:0:0:0:0:0:0:1');
INSERT INTO `sys_user` VALUES ('14', 'Kate', '15214556687', '1157266003@qq.com', '72E080B6A8A9EE63A99D9314F9EC0F0B', '1', '1', '', 'Admin', '2019-03-23 15:27:51', '127.0.0.1');
INSERT INTO `sys_user` VALUES ('15', '小王', '15214556681', '1157266003@qq.com', '25D55AD283AA400AF464C76D713C07AD', '11', '1', '000', 'Admin', '2019-03-23 16:49:23', '127.0.0.1');
INSERT INTO `sys_user` VALUES ('16', 'Kate', '15214556687', '1157266003@qq.com', '065FB635C564CE7188DA9B3E0390A56B', '18', '1', '', 'Admin', '2019-03-23 15:40:40', '127.0.0.1');
INSERT INTO `sys_user` VALUES ('17', '框架和空间', '15214885594', '1157266003@qq.com', 'BD39BF4964DB4472F227137778F048BB', '11', '1', '', 'Admin', '2019-03-25 10:40:21', '127.0.0.1');
INSERT INTO `sys_user` VALUES ('18', '爱的飒飒的', '15214556688', '1157266003@qq.com', 'C901045289B4E159046403084A92D187', '11', '1', '', 'Admin', '2019-03-25 10:44:40', '127.0.0.1');
